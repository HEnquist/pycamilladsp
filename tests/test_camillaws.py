...
def test_queries(camilla_mockquery):
    ...
    camilla_mockquery.config.path()
    camilla_mockquery.query.assert_called_with('GetConfigName')
    camilla_mockquery.config.set_path("some/path")
    camilla_mockquery.query.assert_called_with('SetConfigName', arg="some/path")
